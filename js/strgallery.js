...
var titles = ["Untitled.", "Rapunzel's Tower.","The Coast's Guard.", "Teleporter.", "Lone light on an empty street.", "Road to a new world.", "Corners.", 
            "Pedestrians.", "Geometry class.", "The maze.", "Sound the alarm.", "Heaven's Gate."]
    ...
    galleryImages.forEach(function(image, index) {
        image.onclick = function() {
            ...
            if (ind < 12) {
                ...
                setFinalImgUrl = setNewImgUrl.replace("strs", "str");
            }
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "images/str" + calcNewImg + ".jpg");
    newImg.setAttribute("id", "current-img");
