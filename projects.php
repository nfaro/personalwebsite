<html>
    ...
    <body>
        ...
        <!-- This section is for the username and password verification. The username
            and password have been changed in order to put this code on github. -->
        <?php
        $unameErr = $pwdErr = "";
        $uname = $pwd = "";
        ...
        <header>
            ...
            <div id = "header-words">
                <p data-aos = "zoom-out">PERSONAL PROJECTS</p>
                <p id = "arrow">&darr;</p>
            </div>
        </header>
        <div class = "below">
            <section class = "third">
                <img class = "large-three" data-aos = "fade-right" src="/images/personal.jpg" alt="Me!">
                <div class = "layer three" style = "text-align: center;">
                    <h1 class = "title">Welcome to my Personal Projects!</h1>
                    <div class = "third p">
                        <div>
                            These are coding projects that I have done on my own time just for the fun of it. One of them is this website! 
                            Unfortunately due to privacy, the scripts themselves are only available to those who have talked with me. If you have the login credentials, 
                            feel free to log in below.
                        </div>
                    </div>
                    <div class="center">
